...
"""autogenerated by genpy from piksi_rtk_msgs/ReceiverState_V2_4_1.msg. Do not edit."""
import codecs
import sys
...
class ReceiverState_V2_4_1(genpy.Message):
  _md5sum = "bc31368910e5ef65a7de1c3044300708"
  _type = "piksi_rtk_msgs/ReceiverState_V2_4_1"
...
"""
  ...
  __slots__ = ['header','num_sat','rtk_mode_fix','sat','cn0','system_error','io_error','swift_nap_error','external_antenna_present','num_gps_sat','cn0_gps','num_sbas_sat','cn0_sbas','num_glonass_sat','cn0_glonass','num_bds_sat','cn0_bds','num_gal_sat','cn0_gal','fix_mode']
  _slot_types = ['std_msgs/Header','uint8','bool','uint8[]','uint8[]','uint8','uint8','uint8','uint8','uint8','uint8[]','uint8','uint8[]','uint8','uint8[]','uint8','uint8[]','uint8','uint8[]','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,num_sat,rtk_mode_fix,sat,cn0,system_error,io_error,swift_nap_error,external_antenna_present,num_gps_sat,cn0_gps,num_sbas_sat,cn0_sbas,num_glonass_sat,cn0_glonass,num_bds_sat,cn0_bds,num_gal_sat,cn0_gal,fix_mode
    ...
    """
    if args or kwds:
      super(ReceiverState_V2_4_1, self).__init__(*args, **kwds)
