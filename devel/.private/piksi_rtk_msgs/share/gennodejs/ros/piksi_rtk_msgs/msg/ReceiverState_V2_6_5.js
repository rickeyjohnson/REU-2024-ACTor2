...
class ReceiverState_V2_6_5 {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.external_antenna_short = null;
      ...
      if (initObj.hasOwnProperty('external_antenna_short')) {
        this.external_antenna_short = initObj.external_antenna_short
      }
      else {
        this.external_antenna_short = 0;
      }
      ...
      if (initObj.hasOwnProperty('utc_time_ready')) {
        this.utc_time_ready = initObj.utc_time_ready
      }
      else {
        this.utc_time_ready = false;
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [external_antenna_short]
    bufferOffset = _serializer.uint8(obj.external_antenna_short, buffer, bufferOffset);
    ...
    // Serialize message field [utc_time_ready]
    bufferOffset = _serializer.bool(obj.utc_time_ready, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ReceiverState_V2_6_5(null);
    ...
    // Deserialize message field [external_antenna_short]
    data.external_antenna_short = _deserializer.uint8(buffer, bufferOffset);
    ...
    // Deserialize message field [utc_time_ready]
    data.utc_time_ready = _deserializer.bool(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += _getByteLength(object.fix_mode);
    return length + 45;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ReceiverState_V2_6_5(null);
    ...
    if (msg.external_antenna_short !== undefined) {
      resolved.external_antenna_short = msg.external_antenna_short;
    }
    else {
      resolved.external_antenna_short = 0
    }
    ...
    if (msg.utc_time_ready !== undefined) {
      resolved.utc_time_ready = msg.utc_time_ready;
    }
    else {
      resolved.utc_time_ready = false
    }
...
ReceiverState_V2_6_5.Constants = {
...
module.exports = ReceiverState_V2_6_5;
