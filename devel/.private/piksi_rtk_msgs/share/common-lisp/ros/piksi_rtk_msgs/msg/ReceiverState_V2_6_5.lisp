...
;//! \htmlinclude ReceiverState_V2_6_5.msg.html

(cl:defclass <ReceiverState_V2_6_5> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
   ...
   (external_antenna_short
    :reader external_antenna_short
    :initarg :external_antenna_short
    :type cl:fixnum
    :initform 0)
   ...
   (fix_mode
    ...
    :initform "")
   (utc_time_ready
    :reader utc_time_ready
    :initarg :utc_time_ready
    :type cl:boolean
    :initform cl:nil))
)

(cl:defclass ReceiverState_V2_6_5 (<ReceiverState_V2_6_5>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <ReceiverState_V2_6_5>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'ReceiverState_V2_6_5)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name piksi_rtk_msgs-msg:<ReceiverState_V2_6_5> is deprecated: use piksi_rtk_msgs-msg:ReceiverState_V2_6_5 instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <ReceiverState_V2_6_5>))
...
(cl:defmethod num_sat-val ((m <ReceiverState_V2_6_5>))
...
(cl:defmethod rtk_mode_fix-val ((m <ReceiverState_V2_6_5>))
...
(cl:defmethod sat-val ((m <ReceiverState_V2_6_5>))
...
(cl:defmethod cn0-val ((m <ReceiverState_V2_6_5>))
...
(cl:defmethod system_error-val ((m <ReceiverState_V2_6_5>))
...
(cl:defmethod io_error-val ((m <ReceiverState_V2_6_5>))
...
(cl:defmethod swift_nap_error-val ((m <ReceiverState_V2_6_5>))
...
(cl:ensure-generic-function 'external_antenna_short-val :lambda-list '(m))
(cl:defmethod external_antenna_short-val ((m <ReceiverState_V2_6_5>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader piksi_rtk_msgs-msg:external_antenna_short-val is deprecated.  Use piksi_rtk_msgs-msg:external_antenna_short instead.")
  (external_antenna_short m))

(cl:ensure-generic-function 'external_antenna_present-val :lambda-list '(m))
(cl:defmethod external_antenna_present-val ((m <ReceiverState_V2_6_5>))
...
(cl:defmethod num_gps_sat-val ((m <ReceiverState_V2_6_5>))
...
(cl:defmethod cn0_gps-val ((m <ReceiverState_V2_6_5>))
...
(cl:defmethod num_sbas_sat-val ((m <ReceiverState_V2_6_5>))
...
(cl:defmethod cn0_sbas-val ((m <ReceiverState_V2_6_5>))
...
(cl:defmethod num_glonass_sat-val ((m <ReceiverState_V2_6_5>))
...
(cl:defmethod cn0_glonass-val ((m <ReceiverState_V2_6_5>))
...
(cl:defmethod num_bds_sat-val ((m <ReceiverState_V2_6_5>))
...
(cl:defmethod cn0_bds-val ((m <ReceiverState_V2_6_5>))
...
(cl:defmethod num_gal_sat-val ((m <ReceiverState_V2_6_5>))
...
(cl:defmethod cn0_gal-val ((m <ReceiverState_V2_6_5>))
...
(cl:defmethod fix_mode-val ((m <ReceiverState_V2_6_5>))
...
(cl:ensure-generic-function 'utc_time_ready-val :lambda-list '(m))
(cl:defmethod utc_time_ready-val ((m <ReceiverState_V2_6_5>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader piksi_rtk_msgs-msg:utc_time_ready-val is deprecated.  Use piksi_rtk_msgs-msg:utc_time_ready instead.")
  (utc_time_ready m))
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql '<ReceiverState_V2_6_5>)))
    "Constants for message type '<ReceiverState_V2_6_5>"
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ReceiverState_V2_6_5>) ostream)
  "Serializes a message object of type '<ReceiverState_V2_6_5>"
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'external_antenna_short)) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'utc_time_ready) 1 0)) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ReceiverState_V2_6_5>) istream)
  "Deserializes a message object of type '<ReceiverState_V2_6_5>"
  ...
  (cl:let ((vals (cl:slot-value msg 'cn0)))
    ...
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'external_antenna_short)) (cl:read-byte istream))
  ...
  (cl:let ((vals (cl:slot-value msg 'cn0_gal)))
    ...
    (cl:setf (cl:slot-value msg 'utc_time_ready) (cl:not (cl:zerop (cl:read-byte istream))))
  msg
)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ReceiverState_V2_6_5>)))
  "Returns string type for a message object of type '<ReceiverState_V2_6_5>"
  "piksi_rtk_msgs/ReceiverState_V2_6_5")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ReceiverState_V2_6_5)))
  "Returns string type for a message object of type 'ReceiverState_V2_6_5"
  "piksi_rtk_msgs/ReceiverState_V2_6_5")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ReceiverState_V2_6_5>)))
  "Returns md5sum for a message object of type '<ReceiverState_V2_6_5>"
  "d88343740d272eeb89728ea3bf759f7e")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ReceiverState_V2_6_5)))
  "Returns md5sum for a message object of type 'ReceiverState_V2_6_5"
  "d88343740d272eeb89728ea3bf759f7e")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ReceiverState_V2_6_5>)))
  "Returns full string definition for message of type '<ReceiverState_V2_6_5>"
  (cl:format cl:nil "# Miscellaneous information form different SBP messages~%~%# Message definition based on libsbp v2.6.5~%~%~%Header header~%~%uint8 num_sat                   # Number of satellites.~%bool rtk_mode_fix 	            # 1 = Fixed, 0 = Float.~%uint8[] sat                     # Constellation-specific satellite identifier.~%uint8[] cn0                     # Carrier-to-Noise density. Zero implies invalid cn0 [dB Hz / 4].~%uint8 system_error              # System Error Flag.~%uint8 io_error                  # IO Error Flag.~%uint8 swift_nap_error           # SwiftNAP Error Flag.~%uint8 external_antenna_short    # External Antenna Short Flag.~%uint8 external_antenna_present  # External Antenna Present Flag.~%uint8 num_gps_sat               # Number of GPS satellites.~%uint8[] cn0_gps                 # Carrier-to-Noise density of GPS satellites. Zero implies invalid cn0 [dB Hz / 4].~%uint8 num_sbas_sat              # Number of SBAS satellites.~%uint8[] cn0_sbas                # Carrier-to-Noise density of SBAS satellites. Zero implies invalid cn0 [dB Hz / 4].~%uint8 num_glonass_sat           # Number of GLONASS satellites.~%uint8[] cn0_glonass             # Carrier-to-Noise density of GLONASS satellites. Zero implies invalid cn0 [dB Hz / 4].~%uint8 num_bds_sat               # Number of BEIDOU satellites.~%uint8[] cn0_bds                 # Carrier-to-Noise density of Beidou satellites. Zero implies invalid cn0 [dB Hz / 4].~%uint8 num_gal_sat               # Number of GALILEO satellites.~%uint8[] cn0_gal                 # Carrier-to-Noise density of GALILEO satellites. Zero implies invalid cn0 [dB Hz / 4].~%string fix_mode                 # Invalid, Single Point Position (SPP), Differential GNSS (DGNSS), Float RTK, Fixed RTK.~%bool utc_time_ready             # Indicates whether sensor data time can be converted to UTC time.~%~%# codes available in message \"MeasurementState.msg\"~%~%string STR_FIX_MODE_INVALID        = Invalid~%string STR_FIX_MODE_SPP            = SPP~%string STR_FIX_MODE_DGNSS          = DGNSS~%string STR_FIX_MODE_FLOAT_RTK      = FLOAT_RTK~%string STR_FIX_MODE_FIXED_RTK      = FIXED_RTK~%string STR_FIX_MODE_DEAD_RECKONING = DEAD_RECKONING~%string STR_FIX_MODE_SBAS           = SBAS~%string STR_FIX_MODE_UNKNOWN        = Unknown~%~%uint8 STATUS_UNKNOWN = 255~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ReceiverState_V2_6_5)))
  "Returns full string definition for message of type 'ReceiverState_V2_6_5"
  (cl:format cl:nil "# Miscellaneous information form different SBP messages~%~%# Message definition based on libsbp v2.6.5~%~%~%Header header~%~%uint8 num_sat                   # Number of satellites.~%bool rtk_mode_fix 	            # 1 = Fixed, 0 = Float.~%uint8[] sat                     # Constellation-specific satellite identifier.~%uint8[] cn0                     # Carrier-to-Noise density. Zero implies invalid cn0 [dB Hz / 4].~%uint8 system_error              # System Error Flag.~%uint8 io_error                  # IO Error Flag.~%uint8 swift_nap_error           # SwiftNAP Error Flag.~%uint8 external_antenna_short    # External Antenna Short Flag.~%uint8 external_antenna_present  # External Antenna Present Flag.~%uint8 num_gps_sat               # Number of GPS satellites.~%uint8[] cn0_gps                 # Carrier-to-Noise density of GPS satellites. Zero implies invalid cn0 [dB Hz / 4].~%uint8 num_sbas_sat              # Number of SBAS satellites.~%uint8[] cn0_sbas                # Carrier-to-Noise density of SBAS satellites. Zero implies invalid cn0 [dB Hz / 4].~%uint8 num_glonass_sat           # Number of GLONASS satellites.~%uint8[] cn0_glonass             # Carrier-to-Noise density of GLONASS satellites. Zero implies invalid cn0 [dB Hz / 4].~%uint8 num_bds_sat               # Number of BEIDOU satellites.~%uint8[] cn0_bds                 # Carrier-to-Noise density of Beidou satellites. Zero implies invalid cn0 [dB Hz / 4].~%uint8 num_gal_sat               # Number of GALILEO satellites.~%uint8[] cn0_gal                 # Carrier-to-Noise density of GALILEO satellites. Zero implies invalid cn0 [dB Hz / 4].~%string fix_mode                 # Invalid, Single Point Position (SPP), Differential GNSS (DGNSS), Float RTK, Fixed RTK.~%bool utc_time_ready             # Indicates whether sensor data time can be converted to UTC time.~%~%# codes available in message \"MeasurementState.msg\"~%~%string STR_FIX_MODE_INVALID        = Invalid~%string STR_FIX_MODE_SPP            = SPP~%string STR_FIX_MODE_DGNSS          = DGNSS~%string STR_FIX_MODE_FLOAT_RTK      = FLOAT_RTK~%string STR_FIX_MODE_FIXED_RTK      = FIXED_RTK~%string STR_FIX_MODE_DEAD_RECKONING = DEAD_RECKONING~%string STR_FIX_MODE_SBAS           = SBAS~%string STR_FIX_MODE_UNKNOWN        = Unknown~%~%uint8 STATUS_UNKNOWN = 255~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <ReceiverState_V2_6_5>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <ReceiverState_V2_6_5>))
  "Converts a ROS message object to a list"
  (cl:list 'ReceiverState_V2_6_5
    ...
    (cl:cons ':external_antenna_short (external_antenna_short msg))
    ...
    (cl:cons ':utc_time_ready (utc_time_ready msg))
))
