...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SettingsWrite-request>)))
  ...
  (cl:format cl:nil "# Set a setting into Piksi firmware by specifying the section of the setting (e.g. \"surveyed_position\"),~%# the setting name (e.g. \"surveyed_lat\") and its value (e.g. \"8.57\").~%~%string section_setting~%string setting~%string value~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SettingsWrite-request)))
  "Returns full string definition for message of type 'SettingsWrite-request"
  (cl:format cl:nil "# Set a setting into Piksi firmware by specifying the section of the setting (e.g. \"surveyed_position\"),~%# the setting name (e.g. \"surveyed_lat\") and its value (e.g. \"8.57\").~%~%string section_setting~%string setting~%string value~%~%~%"))
