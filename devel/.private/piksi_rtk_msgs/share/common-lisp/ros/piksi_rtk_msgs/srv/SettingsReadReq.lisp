...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SettingsReadReq-request>)))
  ...
  (cl:format cl:nil "# Request a read of a setting into Piksi firmware by specifying the section of the setting (e.g. \"surveyed_position\")~%# and the setting name (e.g. \"surveyed_lat\").~%~%string section_setting~%string setting~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SettingsReadReq-request)))
  "Returns full string definition for message of type 'SettingsReadReq-request"
  (cl:format cl:nil "# Request a read of a setting into Piksi firmware by specifying the section of the setting (e.g. \"surveyed_position\")~%# and the setting name (e.g. \"surveyed_lat\").~%~%string section_setting~%string setting~%~%~%"))
