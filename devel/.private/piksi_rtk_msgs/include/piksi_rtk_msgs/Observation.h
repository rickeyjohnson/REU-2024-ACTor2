...
struct Observation_
{
  ...
  _n_obs_type n_obs;
   ...
   typedef std::vector<uint32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint32_t>> _P_type;
  _P_type P;

   typedef std::vector<int32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int32_t>> _L_i_type;
  _L_i_type L_i;

   typedef std::vector<uint8_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint8_t>> _L_f_type;
  _L_f_type L_f;

   typedef std::vector<int16_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int16_t>> _D_i_type;
  _D_i_type D_i;

   typedef std::vector<uint8_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint8_t>> _D_f_type;
  _D_f_type D_f;
  ...
  _flags_type flags;
   ...
   typedef std::vector<uint8_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint8_t>> _sid_sat_type;
  _sid_sat_type sid_sat;

   typedef std::vector<uint8_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint8_t>> _sid_code_type;
...
bool operator==(const ::piksi_rtk_msgs::Observation_<ContainerAllocator1> & lhs, const ::piksi_rtk_msgs::Observation_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.tow == rhs.tow &&
    lhs.ns_residual == rhs.ns_residual &&
    lhs.wn == rhs.wn &&
    lhs.n_obs == rhs.n_obs &&
    lhs.P == rhs.P &&
    lhs.L_i == rhs.L_i &&
    ...
    lhs.lock == rhs.lock &&
    lhs.flags == rhs.flags &&
    lhs.sid_sat == rhs.sid_sat &&
    lhs.sid_code == rhs.sid_code;
}
