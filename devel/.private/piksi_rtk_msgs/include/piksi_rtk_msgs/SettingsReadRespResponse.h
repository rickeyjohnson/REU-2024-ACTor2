...
bool operator==(const ::piksi_rtk_msgs::SettingsReadRespResponse_<ContainerAllocator1> & lhs, const ::piksi_rtk_msgs::SettingsReadRespResponse_<ContainerAllocator2> & rhs)
{
  return lhs.success == rhs.success &&
    lhs.message == rhs.message &&
    lhs.section_setting == rhs.section_setting &&
