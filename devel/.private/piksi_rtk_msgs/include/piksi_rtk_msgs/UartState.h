...
bool operator==(const ::piksi_rtk_msgs::UartState_<ContainerAllocator1> & lhs, const ::piksi_rtk_msgs::UartState_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.uart_a_tx_throughput == rhs.uart_a_tx_throughput &&
    lhs.uart_a_rx_throughput == rhs.uart_a_rx_throughput &&
    lhs.uart_a_crc_error_count == rhs.uart_a_crc_error_count &&
    lhs.uart_a_io_error_count == rhs.uart_a_io_error_count &&
    lhs.uart_a_tx_buffer_level == rhs.uart_a_tx_buffer_level &&
    lhs.uart_a_rx_buffer_level == rhs.uart_a_rx_buffer_level &&
    lhs.uart_b_tx_throughput == rhs.uart_b_tx_throughput &&
    lhs.uart_b_rx_throughput == rhs.uart_b_rx_throughput &&
    lhs.uart_b_crc_error_count == rhs.uart_b_crc_error_count &&
    lhs.uart_b_io_error_count == rhs.uart_b_io_error_count &&
    lhs.uart_b_tx_buffer_level == rhs.uart_b_tx_buffer_level &&
    lhs.uart_b_rx_buffer_level == rhs.uart_b_rx_buffer_level &&
    lhs.uart_ftdi_tx_throughput == rhs.uart_ftdi_tx_throughput &&
    lhs.uart_ftdi_rx_throughput == rhs.uart_ftdi_rx_throughput &&
    lhs.uart_ftdi_crc_error_count == rhs.uart_ftdi_crc_error_count &&
    lhs.uart_ftdi_io_error_count == rhs.uart_ftdi_io_error_count &&
    lhs.uart_ftdi_tx_buffer_level == rhs.uart_ftdi_tx_buffer_level &&
    lhs.uart_ftdi_rx_buffer_level == rhs.uart_ftdi_rx_buffer_level &&
    lhs.latency_avg == rhs.latency_avg &&
    lhs.latency_lmin == rhs.latency_lmin &&
    lhs.latency_lmax == rhs.latency_lmax &&
    lhs.latency_current == rhs.latency_current &&
    lhs.obs_period_avg == rhs.obs_period_avg &&
    lhs.obs_period_pmin == rhs.obs_period_pmin &&
    lhs.obs_period_pmax == rhs.obs_period_pmax &&
    lhs.obs_period_current == rhs.obs_period_current;
}
