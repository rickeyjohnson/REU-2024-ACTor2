...
#dynamic reconfigure callback function that updates the global variables: thresh, speed, drive
...
def image_callback(ros_image):
    ...
    try:
        cv2.drawContours(cv_image, best_contour, -1, (0,0,255), thickness = cv2.FILLED)
    ...
    try:
        cx, cy = int(M['m10']/M['m00']), int(M['m01']/M['m00'])         #find center of contour
