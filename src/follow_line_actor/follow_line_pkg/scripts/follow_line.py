...
from follow_line_pkg.cfg import (
    FollowLineConfig,
)  # from package_name.cfg import cfgNameConfig
...
if __name__ == "__main__":
    ...
    rospy.Subscriber(
        imgtopic, Image, image_callback
    )  # subscribe to image (so that image_callback can be called every time an image is published)
